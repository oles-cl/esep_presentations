...
data_ola0 |>
  ...
  labs(caption = "Fuente: ESEP 2023, ola 0.",
       color="Respuesta")+
  scale_color_manual(values = palette_oles_5)
```
...
data_ola0 |>
  ...
  scale_fill_manual(values = c("#35b779","#35b779","#35b779",
                               "#35b779","#35b779","grey"))+
  guides(fill=FALSE)
...
data_ola0 |>
  ...
  scale_fill_manual(values = c("#31688e","#31688e","#31688e",
                               "#31688e","#31688e","grey"))+
  guides(fill=FALSE)
...
data_ola0 |>
  ...
  scale_fill_manual(values = c("#440154","#440154","#440154",
                               "#440154","#440154","grey"))+
  geom_text(aes(label=paste0(prop,"%"),hjust=-0.2),size=6) +
  guides(fill=FALSE)+
  coord_flip()+
  labs(caption="Fuente: ESEP 2023, Ola 0")
